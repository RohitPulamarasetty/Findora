...
export function SupportCTA({
  ...
  return (
    <div className="from-[#7C4DFF]/8 relative overflow-hidden rounded-3xl border border-white/[0.08] bg-gradient-to-br via-[#090D1F]/60 to-[#FF7A18]/5 p-6 backdrop-blur-md sm:p-9">
      <div className="bg-[#7C4DFF]/12 pointer-events-none absolute -left-16 -top-16 h-60 w-60 rounded-full blur-[80px]" />
      <div className="pointer-events-none absolute -bottom-16 -right-16 h-60 w-60 rounded-full bg-[#FF7A18]/10 blur-[80px]" />

      <div className="relative grid items-center gap-6 sm:grid-cols-[1fr_auto] sm:gap-10">
        <div>
          <div className="bg-[#7C4DFF]/12 mb-3 inline-flex items-center gap-1.5 rounded-full border border-[#7C4DFF]/30 px-2.5 py-0.5 text-[10.5px] font-semibold uppercase tracking-[0.15em] text-[#C4B5FD]">
            <Heart size={11} />
            {ctaLabel}
          </div>
        ...
        <div className="flex justify-start sm:justify-end">
          <SupportButton label={ctaLabel}>
            <button
              type="button"
              className="group relative inline-flex items-center gap-2 overflow-hidden rounded-xl px-6 py-3 text-[13.5px] font-semibold text-white shadow-[0_8px_24px_rgba(124,77,255,0.40),inset_0_1px_0_rgba(255,255,255,0.18)] transition-all hover:-translate-y-px hover:shadow-[0_12px_32px_rgba(124,77,255,0.58),inset_0_1px_0_rgba(255,255,255,0.22)]"
            >
              <span className="absolute inset-0 bg-gradient-to-br from-[#7C4DFF] via-[#6D28D9] to-[#5B21B6]" />
